...
st.title(f'Montioring dashboard 🔎')
...
@st.cache_data
def _load_predictions_and_actual_values_from_store(
    from_date: datetime, 
    to_date: datetime
    ) -> pd.DataFrame:
...
with st.spinner(text="Plotting aggregate MAE hour-by-hour for top locations"):
