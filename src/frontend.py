...
#     predictions_df['pickup_ts'] = predictions_df['pickup_hour'].astype(int) // 10**6
#     st.sidebar.write('✅ Model predictions arrived')
...
with st.spinner(text="Plotting time-series data"):
    ...
    # argsort sorts predictions in asc order and [::-1] reverses the order
    ...
    for row_id in row_indices[:n_to_plot]:
        ...
        location_name = df.loc[df.LocationID == location_id, 'zone'].values[0]
        ...
        fig = plot_one_sample(
            ...
            predictions=predictions_df['predicted_demand'],
            display_title=False,
        )
