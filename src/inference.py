...
def load_batch_of_features_from_store(
    ...
    """Fetches the batch of features used by the ML system at `current date`
    ...
    # validate we are not missing data in feature store
    ...
    features['pickup_ts'] = features['pickup_hour'].astype(int) // 10**6
